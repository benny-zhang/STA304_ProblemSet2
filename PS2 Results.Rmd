...
$$
FeelingsOfLife = 6.29 + 0.37x_{income_1} + 0.54x_{income_2} + 0.62x_{income_3} 
...
$$
FeelingsOfLife = \beta + \beta_1 x_{income_i} + \beta_2 x_{own_i} + \beta_3 x_{work_i}
$$
...
ggplot(data = dat1, aes(x = income_range, y = income_weight)) +
  ...
  labs(title = "Comparison between the coefficients of the income categories", 
       x = "Income Family",
...
ggplot(data = dat2, aes(x = own_rent, y = coefficients)) +
  geom_bar(stat="identity", fill = "red") +
  labs(title = "Comparison between the coefficients of owning and renting", 
       x = "Own/Rent",
       y = "Coefficient from Model")
...
ggplot(data = dat3, aes(x = hr, y = coefficients2)) +
  geom_bar(stat="identity", fill = "red") +
  labs(title = "Comparison between the coefficients of the working hours categories", 
